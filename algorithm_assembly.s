...
LOOP		ADD R4,R4,#1
			...
			ADD  R7,[R6,#-16]	;WEIGHT 1 FOR DIAGNOAL ELEMENT (UPPER LEFT)
			ADD  R7,[R6,#-14]	;WEIGHT 1 FOR DIAGNOAL ELEMENT (UPPER RIGHT)
			ADD  R7,[R6,#+14]	;WEIGHT 1 FOR DIAGNOAL ELEMENT (LOWER LEFT)
			ADD	 R7,[R6,#+16]	;WEIGHT 1 FOR DIAGNOAL ELEMENT (LOWER RIGHT)
			
			MOV  R8,[R6,#-15]	;WEIGHT 2 FOR ABOVE ELEMENT
			ADD  R7,R8,LSL#1	
			MOV  R8,#0
