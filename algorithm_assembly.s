...
LOOP		ADD R4,R4,#1
			...
			LDR  R10,[R6]
			ADD  R7,R10,LSL#2		;WEIGHT 4 FOR CURRENT ELEMNET
			MOV  R10,#0
			...
			LDR  R9,[R6,#-17]
			MOV  R8,R9			
			ADD  R7,R8,LSL#1		;WEIGHT 2 FOR ABOVE ELEMENT
			MOV  R8,#0
			MOV  R9,#0
			
			LDR  R9,[R6,#-1]
			MOV  R8,R9      	
			ADD  R7,R8,LSL#1		;WEIGHT 2 FOR LEFT ELEMENT
			MOV  R8,#0
			MOV  R9,#0
			
			LDR  R9,[R6,#+1]
			MOV  R8,R9		
			ADD  R7,R8,LSL#1		;WEIGHT 2 FOR RIGHT ELEMENT
			MOV  R8,#0
			MOV  R9,#0
			
			LDR  R9,[R6,#+17]
			MOV	 R8,R9		
			ADD  R7,R8,LSL#1		;WEIGHT 2 FOR BELOW ELEMENT
			MOV  R8,#0
			MOV  R9,#0
